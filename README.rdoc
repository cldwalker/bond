...
and argument completion of some 60+ methods including Hash#[], Kernel#system, Kernel#require and some Rails methods.
...
By default, Bond autocompletes arguments for a number of core methods:
  ...
  $ irb
  # anything in $LOAD_PATH and gems
  >> require 'rb[TAB]
...
=== Creating Method Argument Completions
To dynamically generate completions per object as in the case of Hash#[]:
